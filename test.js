...
if (test.basics) {
	...
	function tests() {
		...
		assert( machine.tick( time(1) ) === 50 );
		assert( machine.tick( time(2) ) === 50 );
		assert( machine.tick( time(3) ) === 50 );
		assert( machine.tick( time(4) ) === 50 );
		assert( machine.tick( time(5) ) === 50 );
		...
		assert( machine.goto( 100 ) === true );
		assert( machine.state === 'idle' );
		assert( machine.goto( 16.78 ) === true);
		assert( machine.state === 'descend' );
		assert( machine.tick( time(1) ) === 75 );
		assert( machine.tick( time(1) ) === 50 );
		assert( machine.tick( time(1) ) === 25 );
		assert( machine.tick( time(1) ) === 16.78 );
		assert( machine.state === 'descend' );
		assert( machine.tick( time(1) ) === 16.78 );
		assert( machine.state === 'idle' );
		assert( machine.tick( time(1) ) === 16.78 );
		...
		assert( machine.goto( 0 ) === true );
		assert( machine.state === 'idle' );
		assert( machine.goto( 72.25 ) === true);
		assert( machine.state === 'climb' );
		assert( machine.tick( time(1) ) === 25 );
		assert( machine.tick( time(1) ) === 50 );
		assert( machine.tick( time(1) ) === 72.25 );
		assert( machine.state === 'climb' );
		assert( machine.tick( time(1) ) === 72.25 );
		assert( machine.state === 'idle' );
		assert( machine.tick( time(1) ) === 72.25 );
...
if (test.advanced) {
	...
	function tests() {
		...
		for (var i=0; i<4; i=fixFloat(i+step)) {
			var res = machine.tick( time(step) );
			assert( res === fixFloat(100 / 4 * (i+step)) );
		}
		assert( machine.tick( time(step) ) === 100 );
		assert( machine.tick( time(step) ) === 100 );
		assert( machine.tick( time(step) ) === 100 );
		...
		assert( machine.tick( time(step) ) === 0 );
		assert( machine.tick( time(step) ) === 0 );
		assert( machine.tick( time(step) ) === 0 );
	}
}
...
if (test.adjusted_output) {
	...
	assert( machine.tick( time(step) ) === 88 );
	assert( machine.tick( time(step) ) === 88 );
	assert( machine.tick( time(step) ) === 88 );
	...
	assert( machine.tick( time(step) ) === 22 );
	assert( machine.tick( time(step) ) === 22 );
	assert( machine.tick( time(step) ) === 22 );
}
